...
/**
 * write_history - creates an existing file
 * @info: Par Struct
 *
...
/**
 * read_history - Read history or the file
 * @info: Par Struct
 *
 ...
 * @info: holds potential arguments. Structure used to maintain
 * @buf: buffer
 * @linecount:  Hist linecount
 *
